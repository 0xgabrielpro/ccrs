            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                        <h2 class="text-2xl font-bold p-6">Issues</h2>
                    ...
                    <!-- Anonymous Issues List -->
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        <h2 class="text-2xl font-bold p-6">Anonymous Issues</h2>
                        <ul class="divide-y divide-gray-200">
                            @forelse($anonIssues as $issue)
                                <a href="{{ route('anon-issues.show', $issue) }}" class="block hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <li class="px-4 py-4 sm:px-6 {{ $issue->read_at ? 'bg-gray-100' : 'bg-white' }}">
                                        <div class="flex items-center justify-between">
                                            <div class="text-sm font-medium text-indigo-600 truncate">
                                                {{ $issue->title }}
