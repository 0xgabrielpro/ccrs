        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h1 class="text-3xl font-bold mb-6">All Anonymous Issues</h1>
                    <div class="mb-6 flex items-center justify-between">
                        ...
                        <form method="GET" action="{{ route('anon-issues.index') }}" class="flex w-full max-w-md">
                            <input type="text" name="search" placeholder="Search anonymous issues..." class="w-full border border-gray-300 rounded-l px-4 py-2 dark:text-gray-800">
                        ...
                        <ul class="divide-y divide-gray-200">
                            @forelse($anonIssues as $anonIssue)
                                <li class="px-4 py-4 sm:px-6">
                                    <a href="{{ route('anon-issues.show', $anonIssue) }}" class="block hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg p-4">
